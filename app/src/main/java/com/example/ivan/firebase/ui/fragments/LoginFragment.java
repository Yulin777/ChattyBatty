...
import com.example.ivan.firebase.core.login.LoginContract;
import com.example.ivan.firebase.core.login.LoginPresenter;
import com.example.ivan.firebase.ui.activities.RegisterActivity;
...
public class LoginFragment extends Fragment implements View.OnClickListener, LoginContract.View {
    ...
    private void setDummyCredentials() {
        mETxtEmail.setText("abcd@abcd.abcd");
        mETxtPassword.setText("abcdabcd");
    }
