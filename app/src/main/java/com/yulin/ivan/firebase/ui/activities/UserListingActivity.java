...
import com.yulin.ivan.firebase.core.logout.LogoutContract;
import com.yulin.ivan.firebase.core.logout.LogoutPresenter;
import com.yulin.ivan.firebase.ui.adapters.UserListingPagerAdapter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_logout:
                logout();
                break;
            case R.id.original_content:

                break;
            case R.id.censored_content:

                break;
            case R.id.antagonized_content:
